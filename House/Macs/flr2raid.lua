...
local function Macro()
    ...
    if difficultyGui then
        ...
        voteDifficulty("Normal",0)--Normal, Horror, PurgeHorror
    ...
    local function wv1()
        ...
        placeTower(4, CFrame.new(9974.4541015625, -7.8874640464783, -28.664892196655, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)

        -- 2. Place Iron Saints (Slot 3) -> Indexes 4 to 6
        placeTower(3, CFrame.new(9997.357421875, -7.8874640464783, 0.77599334716797, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(3, CFrame.new(9929.5908203125, -7.9576501846313, -35.011661529541, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(3, CFrame.new(9945.9169921875, -7.9576501846313, -8.7819213867188, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)

        -- 3. Place Angels (Slot 1) -> Indexes 7 to 9
        placeTower(1, CFrame.new(9951.72265625, -8.0187854766846, -9.5175714492798, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(1, CFrame.new(9951.5693359375, -8.0187854766846, -40.046852111816, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(1, CFrame.new(10024.4921875, -8.0187854766846, -48.72989654541, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)

        -- 4. Place Purifiers (Slot 2) -> Indexes 10 to 13
        placeTower(2, CFrame.new(9996.54296875, -7.8874640464783, -9.8096084594727, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(2, CFrame.new(9957.2958984375, -7.8874640464783, -34.619590759277, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(2, CFrame.new(9957.5966796875, -7.8874640464783, -2.8160648345947, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(2, CFrame.new(10020.322265625, -7.8874640464783, -48.914115905762, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)

        -- 5. Place Judicators (Slot 5) -> Indexes 14 to 17
        placeTower(5, CFrame.new(9997.357421875, -7.8874640464783, 0.77599334716797, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(5, CFrame.new(9957.3447265625, -7.6806993484497, -39.568031311035, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(5, CFrame.new(9941.61328125, -7.6806993484497, -2.5724172592163, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(5, CFrame.new(10015.62890625, -7.6806993484497, -49.33568572998, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        placeTower(5, CFrame.new(10015.62890625, -7.6806993484497, -49.33568572998, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
        --placeTower(5, CFrame.new(9997.357421875, -7.8874640464783, 0.77599334716797, 1, 0, 0, 0, 1, 0, 0, 0, 1), 1)
    end

    local function wv5()
        Notify("print", "[Wave 5] Queueing auto-upgrades in priority sequence.")
        
        -- 1. Max Angels (Indexes 7-9)
        for i = 7, 9 do autoUpgradeTower(i, true, 1, 5) end
        
        -- 2. Max Judicators (Indexes 14-17)
        for i = 14, 17 do autoUpgradeTower(i, true, 1, 5) end
        
        -- 3. Max Ravers (Indexes 1-3)
        for i = 1, 3 do autoUpgradeTower(i, true, 1, 5) end
        
        -- 4. Max Purifiers (Indexes 10-13)
        for i = 10, 13 do autoUpgradeTower(i, true, 1, 5) end
        
        -- 5. Max Iron Saints (Indexes 4-6)
        for i = 4, 6 do autoUpgradeTower(i, true, 1, 5) end
    end

    local function wv3()
        -- ADD YOUR WAVE 3 ACTIONS HERE
        Notify("print", "[Wave 3] Template - Add your actions here!")
    end

    local function wv9()
        -- ADD YOUR WAVE 9 ACTIONS HERE
        Notify("print", "[Wave 9] Template - Add your actions here!")
    end

    local function wv19()
        -- ADD YOUR WAVE 19 ACTIONS HERE
        Notify("print", "[Wave 19] Template - Add your actions here!")
    end
